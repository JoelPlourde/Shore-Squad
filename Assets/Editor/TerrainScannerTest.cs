...
public class TerrainScannerTest
{
	...
	public void CheckIfZoneIsWithinTerrain_test() {
		...
		Assert.That(TerrainScanner.CheckIfZoneIsWithinTerrain(terrain, new Vector3(256, 0, 256), 100), Is.True);
		Assert.That(TerrainScanner.CheckIfZoneIsWithinTerrain(terrain, new Vector3(0, 0, 0), 100), Is.False);
		Assert.That(TerrainScanner.CheckIfZoneIsWithinTerrain(terrain, new Vector3(256, 0, 0), 100), Is.False);
		Assert.That(TerrainScanner.CheckIfZoneIsWithinTerrain(terrain, new Vector3(0, 0, 256), 100), Is.False);
		Assert.That(TerrainScanner.CheckIfZoneIsWithinTerrain(terrain, new Vector3(50, 0, 50), 100), Is.True);
	}
	...
	public void GetTerrainMap_test() {
		...
		Assert.That(TerrainScanner.GetTerrainMap(terrain, new Vector3(256, 0, 256), 100, out Map map), Is.True);
